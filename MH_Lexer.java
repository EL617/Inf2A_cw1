...
static class VarAcceptor extends Acceptor implements DFA {
    ...
    switch(state){
        ...
        case 1 : if (CharTypes.isSmall(c) || CharTypes.isLarge(c) || CharType.isDigit(c)) return 1; else return 2;
            default: return 2;
        }
    }
...
static class CommentAcceptor extends Acceptor implements DFA {
    ...
    switch(state){
        ...
        case 2: if (c == '-') return 2; else if (!CharTypes.isSymbolic(c) && CharTypes.isNewline(c)) return 3; else if (c == null) return 3; else return 4;
